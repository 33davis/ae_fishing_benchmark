...
cd /u/davisee/Scratch/synthetic_files
...
align="MALT"
new_directory="/u/davisee/Scratch/synthetic_files/$d-$database"
mkdir "$new_directory"
...
mv /u/davisee/Scratch/synthetic_files/*.kx "$new_directory/"
